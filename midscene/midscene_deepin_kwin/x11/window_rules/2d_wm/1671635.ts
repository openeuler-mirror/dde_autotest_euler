 ...
 * 用例 PMSID: 1671635
 * 用例标题: 窗口级菜单-关闭
 * 生成时间: 2025-12-22 10:25:36
 * 用例编写人: UT006165（李日华）
 */

describe('1671635-窗口级菜单-关闭', () => {
  ...
  test('1671635-窗口级菜单-关闭', async ({ device, agent, uos }) => {
    // 前置条件: 打开文件管理器窗口
  ...
  }, { timeout: 600000, tags: ["1671635", "level1",'x11','window_rules','2d_wm'] });
