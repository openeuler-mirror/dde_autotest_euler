 ...
 * 用例 PMSID: 1671627
 * 用例标题: 窗口级菜单—移动
 * 生成时间: 2025-12-22 10:04:26
 * 用例编写人: UT006165（李日华）
 */

describe('1671627-窗口级菜单—移动', () => {
  ...
  test('1671627-窗口级菜单—移动', async ({ device, agent, uos }) => {
    // 步骤1：打开文件管理器窗口
    ...
    await agent.aiAssert('文件管理器窗口被移动到屏幕右侧');
    await agent.aiAssert('文件管理器窗口显示正常');
  }, { timeout: 600000, tags: ['1671627', 'level1','x11','window_rules','2d_wm'] });
