 ...
 * 用例 PMSID: 1671421
 * 用例标题: 窗口级菜单—最大化/最小化
 * 生成时间: 2025-12-11 15:50:00
 * 用例编写人: UT006165（李日华）
 */

describe('1671421-窗口级菜单—最大化/最小化', () => {
    ...
    test('1671421-窗口级菜单—最大化/最小化', async ({ device, agent, uos }) => {
    ...
    }, { timeout: 600000, tags: ["1671421", "level1",'x11','window_rules','3d_wm'] });
