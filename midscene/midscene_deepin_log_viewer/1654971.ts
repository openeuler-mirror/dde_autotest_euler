/**
 * 用例 PMSID: 1654971
 * 用例标题: 日志收集工具，应用日志分类中增加“子模块”筛选条件
 * 生成时间: 2026-04-23
 * 用例编写人: UT006165（李日华）
 */

describe('1654971-日志收集工具，应用日志分类中增加“子模块”筛选条件', () => {
  ...
  test('1654971-日志收集工具，应用日志分类中增加“子模块”筛选条件', async ({ device, agent, uos, system }) => {
    // 步骤 1: 启动日志收集工具，应用启动成功
    ...
    // 步骤 3: 如果弹出查看此日志需要授权的窗口，在请输入密码框输入uos12345.,然后点击确定按钮
  ...
  }, { timeout: 600000, tags: ['1654971', 'level1', 'smoke'] });
