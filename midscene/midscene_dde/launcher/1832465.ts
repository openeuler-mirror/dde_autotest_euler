/**
 * 用例 PMSID: 1832465
 * 用例标题: 【启动器】【窗口模式】【搜索框】搜索框输入中文
 * 生成时间: 2026/1/30 15:22
 * 用例编写人: UT002998(熊林辉)
 */

describe('1832465-【启动器】【窗口模式】【搜索框】搜索框输入中文', () => {
  ...
  //预置步骤5：收尾按ESC关闭启动器，保持环境干净
    ...
    test('1832465-【启动器】【窗口模式】【搜索框】搜索框输入中文', async ({ device, agent, uos }) => {
      // 步骤 1: 打开启动器
      await uos.openLauncher();
    ...
    }, { timeout: 300000, tags: ["1832465", "level3"] });
