/**
 * 用例 PMSID: 1832325
 * 用例标题: 【启动器】【窗口模式】【“按分类”分类】【键盘操作】单击分类标题，点击Space键进入分类列表
 * 生成时间: 2026/03/18 14:38
 * 用例编写人: UT002998(熊林辉)
 */

describe('1832325-【启动器】【窗口模式】【“按分类”分类】【键盘操作】单击分类标题，点击Space键进入分类列表', () => {
  ...
  test('1832325-【启动器】【窗口模式】【“按分类”分类】【键盘操作】单击分类标题，点击Space键进入分类列表', async ({ device, agent, uos }) => {
    //步骤1：打开启动器
    await uos.openLauncher();
    //步骤2：打开桌面文件夹
    await agent.aiTap({
  ...
  }, { timeout: 300000, tags: ["1832325", "level3"] });
