...
/**
 * 用例 PMSID: 1877793
 * 用例标题: 【控制中心】【系统更新】更新设置页面，下载限速开关开启，输入框报错后鼠标焦点离开输入框，提示信息和红色底框消失，恢复原来的值
 * 生成时间: 2026-02-05 19:57:49
 * 用例编写人: UT001924（李鹤）
 */

describe('1877793-【控制中心】【系统更新】更新设置页面，下载限速开关开启，输入框报错后鼠标焦点离开输入框，提示信息和红色底框消失，恢复原来的值', () => {
  ...
  test('1877793-【控制中心】【系统更新】更新设置页面，下载限速开关开启，输入框报错后鼠标焦点离开输入框，提示信息和红色底框消失，恢复原来的值', async ({ device, agent, uos }) => {
    // 打开控制中心并最大化
    ...
    // 等待报错信息出现
    await agent.aiWaitFor("提示错误信息：只允许输入10-999999,输入框底色为红色");
    // 断言焦点离开输入框，错误提示信息消失，输入框红色底色消失
    await device.pressKey("tab");
    await agent.aiAssert("限速设置区域输入框数字展示1024,'只允许输入10-999999'提示信息消失,下载限速输入框红色底色已消失");
  }, { timeout: 600000, tags: ['1877793', 'level4'] });
