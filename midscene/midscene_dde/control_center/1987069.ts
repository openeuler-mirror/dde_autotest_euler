/**
 * 用例 PMSID: 1987069
 * 用例标题: 【控制中心】【系统更新】【公网】传递优化配置项的下载限速配置项复选框能正常去勾选
 * 生成时间: 2026-06-01 10:00:00
 * 用例编写人:UT000327(秦家喜)
 */

describe('1987069-【控制中心】【系统更新】【公网】传递优化配置项的下载限速配置项复选框能正常去勾选', () => {
  ...
  test('1987069-下载限速复选框能正常去勾选', async ({ device, agent, uos }) => {
    ...
    await agent.aiAssert("传递优化-下载限速复选框已取消勾选");
  }, { timeout: 600000, tags: ['1987069', 'level3'] });
