/**
 * 用例 PMSID: 1985059
 * 用例标题: 【非功能性需求】【dde-dconfig】【控制中心】【电源管理】【使用电源】笔记本合盖时默认值配置检查
 * 生成时间: 2026-04-28
 * 用例编写人: UT001924（李鹤）
 */

describe('1985059-【非功能性需求】【dde-dconfig】【控制中心】【电源管理】【使用电源】笔记本合盖时默认值配置检查', () => {
  const caseDir = process.env.TESTCASE_DIR;

  const testConfig = {
    appID: "org.deepin.dde.daemon",
    source: "org.deepin.dde.daemon.power",
    key: "linePowerLidClosedAction",
    expectedValue: "1"
  };
  ...
  test('1985059-【非功能性需求】【dde-dconfig】【控制中心】【电源管理】【使用电源】笔记本合盖时默认值配置检查', async ({ system }) => {
  ...
  }, { timeout: 600000, tags: ['1985059', 'level3', 'laptop'] });
