...
/**
 * 用例 PMSID: 1877801
 * 用例标题: 【控制中心】【系统更新】更新设置页面，下载限速开关开启，默认值是1024
 * 生成时间: 2026-02-04 10:10:43
 * 用例编写人: UT001924（李鹤）
 */

describe('1877801-【控制中心】【系统更新】更新设置页面，下载限速开关开启，默认值是1024', () => {
  ...
  test('1877801-【控制中心】【系统更新】更新设置页面，下载限速开关开启，默认值是1024', async ({ device, agent, uos }) => {
    // 打开控制中心并最大化
    ...
    // 断言限速值
    await agent.aiAssert("限速设置区域输入框默认值为1024");
  }, { timeout: 600000, tags: ['1877801', 'level3'] });
