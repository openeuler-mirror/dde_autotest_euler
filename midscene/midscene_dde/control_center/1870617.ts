/**
 * 用例 PMSID: 1870617
 * 用例标题:【控制中心】【个性化】【壁纸】选择我的图片，壁纸预览跟随更新展示
 * 生成时间: 2026-04-24
 * 用例编写人:UT005044(王亮)
 */

describe('1870617-【控制中心】【个性化】【壁纸】选择我的图片，壁纸预览跟随更新展示', () => {
    ...
    test('1870617-【控制中心】【个性化】【壁纸】选择我的图片，壁纸预览跟随更新展示', async ({ device, agent, uos }) => {
        // 步骤 1: 打开控制中心
        ...
        // 检查 1: 预览图更新为对应森林壁纸       
        await agent.aiAssert("我的图片上方的预览区更新为对应的森林图片");
        ...
        // 检查 2: 桌面更新为对应极光绿壁纸     
        await agent.aiAssert("我的图片上方的预览区更新为对应极光绿的图片");

    }, { timeout: 700000, tags: ["1870617", "level3"] });
