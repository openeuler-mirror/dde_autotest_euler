...
/**
 * 用例 PMSID: 1824747
 * 用例标题: 【控制中心】【系统】【语言和区域】设置货币负数为1.1-¥
 * 生成时间: 2026-01-29 19:31:59
 * 用例编写人: UT003072(陈佳梅)
 */

describe('1824747-【控制中心】【系统】【语言和区域】设置货币负数为1.1-¥', () => {
  ...
  test('1824747-【控制中心】【系统】【语言和区域】设置货币负数为1.1-¥', async ({ device, agent, uos }) => {
    // 步骤 1: 打开控制中心且最大化控制中心
    ...
    //验证货币负数修改为1.1-¥
    await agent.aiAssert("货币负数显示为1.1-¥");
  }, { timeout: 600000, tags: ['1824747', 'level3'] });
