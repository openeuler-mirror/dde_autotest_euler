/**
 * 用例 PMSID: 1987049
 * 用例标题: 【控制中心】【系统更新】【公网】传递优化配置项的上传限速配置项输入框输入1234567，超过6位后无法继续输入
 * 生成时间: 2026-06-01 10:00:00
 * 用例编写人:UT000327(秦家喜)
 */

describe('1987049-【控制中心】【系统更新】【公网】传递优化配置项的上传限速配置项输入框输入1234567，超过6位后无法继续输入', () => {
  ...
  test('1987049-上传限速输入框超过6位无法继续输入', async ({ device, agent, uos }) => {
    ...
    await agent.aiAssert("传递优化-上传限速输入框显示123456", { deepThink: true });
  }, { timeout: 600000, tags: ['1987049', 'level4'] });
