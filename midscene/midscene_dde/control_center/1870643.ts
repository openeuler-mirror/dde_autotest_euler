/**
 * 用例 PMSID: 1870643
 * 用例标题:【控制中心】【个性化】【壁纸】我的图片-自定义添加壁纸排列顺序
 * 生成时间: 2026-04-24
 * 用例编写人:UT005044(王亮)
 */

describe('1870643-【控制中心】【个性化】【壁纸】我的图片-自定义添加壁纸排列顺序', () => {
    ...
    test('1870643-【控制中心】【个性化】【壁纸】我的图片-自定义添加壁纸排列顺序', async ({ device, agent, uos }) => {
        // 步骤 1: 打开控制中心
        ...
        // 检查 1: 预览图更新为对应森林壁纸       
        await agent.aiAssert("我的图片项中第一个位置更新为对应的森林图片，总共1张图片框");
        ...
        // 检查 2: 桌面更新为对应彩虹色壁纸     
        await agent.aiAssert("我的图片项中的第一个位置更新为对应极光绿的图片，总共2张图片框");

    }, { timeout: 700000, tags: ["1870643", "level3"] });
