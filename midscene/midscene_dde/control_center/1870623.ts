/**
 * 用例 PMSID: 1870623
 * 用例标题:【控制中心】【个性化】【壁纸】我的图片壁纸界面展示
 * 生成时间: 2026-02-05
 * 用例编写人:UT005044(王亮)
 */

describe('1870623-【控制中心】【个性化】【壁纸】我的图片壁纸界面展示', () => {
    ...
    test('1870623-【控制中心】【个性化】【壁纸】我的图片壁纸界面展示', async ({ device, agent, uos }) => {
        // 步骤 1: 打开控制中心
        ...
        await agent.aiAssert("右侧区域的设置项中存在标题：我的图片，默认无壁纸项，第一个位置固定展示“＋”形区域框，存在灰底色文案：添加图片");
        await agent.aiAssert("我的图片项的下方为标题项：系统壁纸");

    }, { timeout: 600000, tags: ["1870623", "level3"] });
