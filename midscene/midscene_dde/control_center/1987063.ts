/**
 * 用例 PMSID: 1987063
 * 用例标题: 【控制中心】【系统更新】【公网】单击传递优化配置项的下载限速配置项速度输入框，选中数值部分
 * 生成时间: 2026-06-01 10:00:00
 * 用例编写人:UT000327(秦家喜)
 */

describe('1987063-【控制中心】【系统更新】【公网】单击传递优化配置项的下载限速配置项速度输入框，选中数值部分', () => {
  ...
  test('1987063-单击下载限速输入框选中数值部分', async ({ device, agent, uos }) => {
    ...
    await agent.aiAssert("传递优化-下载限速'区域输入框被选中为活动色");
  }, { timeout: 600000, tags: ['1987063', 'level3'] });
