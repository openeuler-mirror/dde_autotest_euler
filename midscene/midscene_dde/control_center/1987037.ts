/**
 * 用例 PMSID: 1987037
 * 用例标题: 【控制中心】【系统更新】【公网】改变传递优化配置项的上传限速配置项复选框状态，切换模块，展示切换模块前的状态
 * 生成时间: 2026-06-01 10:00:00
 * 用例编写人:UT000327(秦家喜)
 */

describe('1987037-【控制中心】【系统更新】【公网】改变传递优化配置项的上传限速配置项复选框状态，切换模块，展示切换模块前的状态', () => {
  ...
  test('1987037-改变上传限速复选框状态切换模块展示切换前状态', async ({ device, agent, uos }) => {
    ...
    await agent.aiAssert("传递优化-上传限速复选框为勾选状态");
    ...
    await agent.aiWaitFor("'收起'文字可见");
    await agent.aiAssert("传递优化-上传限速复选框为勾选状态");
  }, { timeout: 1200000, tags: ['1987037', 'level3'] });
