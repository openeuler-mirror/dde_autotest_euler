/**
 * 用例 PMSID: 1987035
 * 用例标题: 【控制中心】【系统更新】【公网】传递优化配置项的上传限速配置项复选框能正常去勾选
 * 生成时间: 2026-06-01 10:00:00
 * 用例编写人:UT000327(秦家喜)
 */

describe('1987035-【控制中心】【系统更新】【公网】传递优化配置项的上传限速配置项复选框能正常去勾选', () => {
  ...
  test('1987035-上传限速复选框能正常去勾选', async ({ device, agent, uos }) => {
    ...
    await agent.aiTap("'传递优化-上传限速'区域复选框");
    await agent.aiHover("空白区域");
    await agent.aiAssert("传递优化-上传限速复选框已取消勾选");
  }, { timeout: 600000, tags: ['1987035', 'level3'] });
