/**
 * 用例 PMSID: 1987059
 * 用例标题: 【控制中心】【系统更新】【公网】传递优化配置项的下载限速配置项速度输入框报错后鼠标焦点离开输入框，提示信息和红色底框消失，恢复原来的值
 * 生成时间: 2026-06-01 10:00:00
 * 用例编写人:UT000327(秦家喜)
 */

describe('1987059-【控制中心】【系统更新】【公网】传递优化配置项的下载限速配置项速度输入框报错后鼠标焦点离开输入框，提示信息和红色底框消失，恢复原来的值', () => {
  ...
  test('1987059-下载限速输入框报错后焦点离开提示消失恢复原值', async ({ device, agent, uos }) => {
  ...
  }, { timeout: 600000, tags: ['1987059', 'level4'] });
