...
/**
 * 用例 PMSID: 1824775
 * 用例标题: 【控制中心】【系统】【语言和区域】设置数字分组为123456,789
 * 生成时间: 2026-01-28 15:30:53
 * 用例编写人: UT003072(陈佳梅)
 */

describe('1824775-【控制中心】【系统】【语言和区域】设置数字分组为123456,789', () => {
  ...
  test('1824775-【控制中心】【系统】【语言和区域】设置数字分组为123456,789', async ({ device, agent, uos }) => {
    // 步骤 1: 打开控制中心且最大化控制中心
    ...
    // 步骤 3：设置数字分组为123456,789
    await agent.aiTap("'数字分组'区域的ˇ符号");
    await agent.aiTap("数字分组下拉框中的[123456,789]选项");
    //验证数字分组修改为123456,789
    await agent.aiAssert("数字分组显示为[123456,789]");
  }, { timeout: 600000, tags: ['1824775', 'level3'] });
