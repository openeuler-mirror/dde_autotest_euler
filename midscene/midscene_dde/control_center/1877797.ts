...
/**
 * 用例 PMSID: 1877797
 * 用例标题: 【控制中心】【系统更新】更新设置页面，下载限速开关开启，输入框输入1234567，超过6位后无法继续输入
 * 生成时间: 2026-02-04 13:52:27
 * 用例编写人: UT001924（李鹤）
 */

describe('1877797-【控制中心】【系统更新】更新设置页面，下载限速开关开启，输入框输入1234567，超过6位后无法继续输入', () => {
  ...
  test('1877797-【控制中心】【系统更新】更新设置页面，下载限速开关开启，输入框输入1234567，超过6位后无法继续输入', async ({ device, agent, uos }) => {
    // 打开控制中心并最大化
    ...
    await device.typeText("1234567");
    //焦点移出输入框，减少输入光标对ai识别造成的干扰
    await device.pressKey("Tab");
    // 断言只能输入5位数
    await agent.aiAssert("限速设置区域输入框中只显示123456");
  }, { timeout: 600000, tags: ['1877797', 'level4'] });
