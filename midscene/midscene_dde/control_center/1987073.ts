/**
 * 用例 PMSID: 1987073
 * 用例标题: 【控制中心】【系统更新】【公网】未修改过传递优化配置项的下载限速数值，打开开关，默认展示10240KB/s
 * 生成时间: 2026-06-01 10:00:00
 * 用例编写人:UT000327(秦家喜)
 */

describe('1987073-【控制中心】【系统更新】【公网】未修改过传递优化配置项的下载限速数值，打开开关，默认展示10240KB/s', () => {
  ...
  test('1987073-未修改过下载限速数值打开开关默认展示10240', async ({ device, agent, uos }) => {
    ...
    await agent.aiAssert("传递优化-下载限速输入框默认显示10240KB/S");
  }, { timeout: 600000, tags: ['1987073', 'level3'] });
