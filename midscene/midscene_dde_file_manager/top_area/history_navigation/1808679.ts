/**
 * 用例 PMSID: 1808679
 * 用例标题:【复制远程路径】地址栏上鼠标右键编辑smb路径
 * 生成时间: 2026-02-06 09:50:26
 * 用例编写人：UT000244(李庆玲)
 */

describe('1808679-【复制远程路径】地址栏上鼠标右键编辑smb路径', () => {
    ...
    test('1808679-【复制远程路径】地址栏上鼠标右键编辑smb路径', async ({ device, agent, uos, system, env, clipboard }) => {
    // 挂载SMB并访问SMB
    ...
    }, { timeout: 1800000, tags: ["1808679", "level2", "history_navigation", "liqingling"] });
