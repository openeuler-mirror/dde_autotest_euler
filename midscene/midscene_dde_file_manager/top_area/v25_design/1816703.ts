/**
 * 用例 PMSID: 1816703
 * 用例标题:  视图选项-图标视图不显示列表高度
 * 生成时间: 2026-2-3 20:00:32
 * 用例编写人：UT002161(陈俞)
 */

describe('1816703-视图选项-图标视图不显示列表高度', () => {
    ...
    test('1816703-视图选项-图标视图不显示列表高度', async ({ device, agent, uos, system, env }) => {  
      // 图标视图下，不显示列表高度选项
      // 点击图标视图图标
      ...
      // 检测视图选项显示正确性
      await agent.aiWaitFor('视图选项的弹框');
      await agent.aiAssert('不存在“列表高度”');
      // 收起视图选项弹框：点击下拉框以外的空白
    ...
    }, { timeout: 1200000, tags: ["1816703", "level2", "v25_design", "chenyu"] });
