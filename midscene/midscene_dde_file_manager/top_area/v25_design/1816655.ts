...
describe('1816655-侧边栏-支持折叠', () => {
    ...
    test('1816655-侧边栏-支持折叠', async ({ device, agent, uos, system, env }) => {  
      ...
      await agent.aiAssert('侧边栏向右展开，恢复折叠前的宽度');
      // await agent.aiAssert('文件管理器的左侧边栏宽度等于步骤1收起之前的宽度');

    }, { timeout: 1200000, tags: ["1816655", "level2", "v25_design", "chenyu"] });
