...
describe('1850179-密钥找回口令', () => {
  ...
  test('1850179-密钥找回口令', async ({ device, agent, uos, env, system }) => {    
  ...
  }, { timeout: 1200000, tags: ['1850179','level2', 'group standard', 'DITT', 'youwei', 'file-manager', 'vault', 'unlock', 'encryption_file'] });
});