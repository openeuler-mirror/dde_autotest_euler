 ...
 * 用例 PMSID: 1807423
 * 用例标题: 属性复制-右键菜单全选
 * 生成时间: 2025-12-30 14:54:22
 * 用例编写人: UT000193（郑豪）
 */

describe('1807423-属性复制-右键菜单全选', () => {
  ...
  test('1807423-属性复制-右键菜单全选', async ({ device, agent, uos }) => {
    // 前置1：打开文件夹属性弹窗
  ...
  }, { timeout: 600000, tags: ['1807423', 'level3', 'file_attributes', 'zhenghao'] });
