/**
 * 用例 PMSID: 1805973
 * 用例标题: 【计算机】系统盘-双击计算机页面系统盘
 * 生成时间: 2025-12-16 10:00:00
 * 用例编写人: UT000211
 */


describe('1805973-【计算机】系统盘-双击计算机页面系统盘', () => {
  ...
  test('1805973-【计算机】系统盘-双击计算机页面系统盘', async ({ uos, agent, device }) => {
    //双击进入系统盘
    await agent.aiDoubleClick('磁盘列表下面的系统盘');
  ...
  }, { timeout: 120000, tags: ["1805973",'level2', 'smoke','chenyi'] });
