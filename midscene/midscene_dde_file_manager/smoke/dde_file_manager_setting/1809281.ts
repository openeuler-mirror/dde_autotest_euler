/**
 * 用例 PMSID: 1809281
 * 用例标题: 【文件管理器】系统盘-选中计算机页面系统盘右键
 * 用例编写人: UT005045(许琪)
 * 生成时间：2025/12/22
 */


describe('1809281-系统盘-选中计算机页面系统盘右键', () => {
    ...
    test('1809281-系统盘-选中计算机页面系统盘右键', async ({ device, agent, uos }) => {
      ...
      await uos.closeCurrentWindow();
    }, { timeout: 1200000, tags: ["1809281",'level1', 'smoke'] });
