...
const COPY_DIR = '~/Desktop/1807795cp'
...
describe('1807795-文管右键菜单显示快捷键-快捷键功能-桌面快捷键删除', () => {
  ...
  test('1807795-文管右键菜单显示快捷键-快捷键功能-桌面快捷键删除', async ({ device, agent, uos }) => {
    // 步骤 1: 进入测试文件夹
    await uos.showDesktop();
    ...
    await agent.aiAssert("桌面没有file02.txt、dir02、归档管理器");
       ...
       tags: ['1807795', 'level2', 'smoke', 'file_operations', 'DITT', 'hujian'] });
