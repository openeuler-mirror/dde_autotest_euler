...
describe('1807425-属性复制-右键菜单复制', () => {
    ...
    test('1807425-属性复制-右键菜单复制', async ({ device,agent,uos,system}) => {
        ...
        await agent.aiRightClick("位置信息右边的Desktop");
        await agent.aiTap("右键菜单中的复制");
        // 步骤3：检查快捷键Ctrl+C是否正常复制粘贴
        await agent.aiRightClick("标记下方的输入框");
       ...
       tags: ['1807425', 'level2', 'smoke', 'file_operations', 'DITT', 'hujian'] });
