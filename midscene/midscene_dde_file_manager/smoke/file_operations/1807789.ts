/**
 * 用例 PMSID: 1807789
 * 用例标题: 文管右键菜单显示快捷键-快捷键功能-桌面快捷键复制粘贴
 * 生成时间: 2025-2-9 10:00:00
 * 用例编写人: UT002411(胡戬)
 */

const TEST_DIR = '~/Desktop'
const COPY_DIR = '~/Desktop/1807789cp'
...
describe('1807789-文管右键菜单显示快捷键-快捷键功能-桌面快捷键复制粘贴', () => {
  ...
  test('1807789-文管右键菜单显示快捷键-快捷键功能-桌面快捷键复制粘贴', async ({ device, agent, uos }) => {
    // 步骤 1: 进入测试文件夹
    await uos.showDesktop();
    ...
    // 步骤3：粘贴文件到测试目录
    await agent.aiDoubleClick('桌面上的1807789cp文件夹');
    ...
    await device.pressKey('Alt','F4');
       ...
       tags: ['1807789', 'level2', 'smoke', 'file_operations', 'DITT', 'hujian'] });
