...
/**
 * 用例 PMSID: 1809241
 * 用例标题: [126]保险箱-保险箱上锁后侧边栏/计算机目录正常呼出右键菜单
 * 生成时间: 2025-12-18 19:53:28
 * 用例编写人：UT006252(杨通)
 */

describe('1809241-[126]保险箱-保险箱上锁后侧边栏/计算机目录正常呼出右键菜单', () => {
  ...
  test('1809241-[126]保险箱-保险箱上锁后侧边栏/计算机目录正常呼出右键菜单', async ({ device, agent, uos }) => {
    ...
    await agent.aiAssert("出现解锁选项");
    
  }, { timeout: 1200000, tags: ['1809241', 'level2','smoke','yangtong'] });
