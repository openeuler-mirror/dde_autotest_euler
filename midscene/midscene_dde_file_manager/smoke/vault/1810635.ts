...
/**
 * 用例 PMSID: 1810635
 * 用例标题: 【Bug转用例场景】保险箱创建后，立即上锁，然后解锁
 * 生成时间: 2025-12-19 17:19:59
 * 用例编写人：UT006252(杨通)
 */

describe('1810635-【Bug转用例场景】保险箱创建后，立即上锁，然后解锁', () => {
  ...
  test('1810635-【Bug转用例场景】保险箱创建后，立即上锁，然后解锁', async ({ device, agent, uos }) => {
    console.log('开始验证立即上锁并解锁');
  ...
  }, { timeout: 1200000, tags: ['1810635', 'level2','smoke','yangtong'] });
