...
/**
 * 用例 PMSID: 1809197
 * 用例标题: 透明加解密 - 【加密方式】选择“透明加密”，“加密保险箱”按钮
 * 生成时间: 2025-12-18 20:28:25
 * 用例编写人：UT006252(杨通)
 */
describe('1809197-透明加解密 - 【加密方式】选择“透明加密”，“加密保险箱”按钮', () => {
    ...
    test('1809197-透明加解密 - 【加密方式】选择“透明加密”，“加密保险箱”按钮', async ({ device, agent, uos }) => {
      const TEST_PASSWORD = process.env.TEST_PASSWORD;
      //透明加密创建保险箱
      console.log('步骤1：透明加密创建保险箱');
    ...
    }, { timeout: 1200000, tags: ['1809197', 'level2', 'smoke','yangtong']  });
