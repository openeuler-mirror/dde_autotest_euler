...
/**
 * 用例 PMSID: 1813065
 * 用例标题: 文管设置：显示 Samba共享常驻，所有目录都为挂载状态
 * 生成时间: 2026-02-27 14:58:28
 * 用例编写人：UT006252(杨通)
 */

describe('1813065-文管设置：显示 Samba共享常驻，所有目录都为挂载状态', () => {
  ...
  test('1813065-文管设置：显示 Samba共享常驻，所有目录都为挂载状态', async ({ device, agent, uos,system }) => {
  ...
  }, { timeout: 1200000, tags: ['1813065', 'level3','smb','DITT','yangtong'] });
