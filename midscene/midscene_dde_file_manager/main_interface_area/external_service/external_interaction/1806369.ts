/**
 * 用例 PMSID: 1806369
 * 用例标题:   日志适配规范-文管日志配置文件查看
 * 用例编写人: UT005045(许琪)
 * 生成时间：2026/2/11
 */

describe('1806369-日志适配规范-文管日志配置文件查看', () => {
    ...
    test('1806369-日志适配规范-文管日志配置文件查看', async ({ device, agent, uos, system }) => {
    ...
    }, { timeout: 1200000, tags: ["1806369", 'level4', 'external_interaction', 'DITT', 'xuqi'] });
