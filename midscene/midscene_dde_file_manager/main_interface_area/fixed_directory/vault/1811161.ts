 ...
 * 用例 PMSID: 1811161
 * 用例标题: 密码找回-入口检查
 * 生成时间: 2026-05-27 16:30:00
 * 用例编写人: UT000159（游伟）
 */

const caseDir = process.env.TESTCASE_DIR;

describe('1811161-密码找回-入口检查', () => {
  ...
  test('1811161-密码找回-入口检查', async ({ device, agent, uos, env, system }) => {
    ...
    // 预期 4: 弹出解锁保险箱对话框, 解锁保险框中有"忘记密码"选项
    console.log('预期 4: 弹出解锁保险箱对话框, 解锁保险框中有"忘记密码"选项');
    await agent.aiAssert('弹出解锁保险箱对话框, 解锁保险框中有忘记密码选项');

  }, { timeout: 1200000, tags: ['1811161', 'level3', 'main interface area', 'fixed directory', 'vault', 'DITT', 'youwei', 'file-manager', 'restore password', 'forgot password'] });
});