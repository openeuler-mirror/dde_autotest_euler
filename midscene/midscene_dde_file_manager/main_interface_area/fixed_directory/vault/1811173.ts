/**
 * 用例 PMSID: 1811173
 * 用例标题: 忘记密码-打开文件选择对话框选择任意错误保险箱密钥文件解锁
...
describe('1811173-忘记密码-打开文件选择对话框选择任意错误保险箱密钥文件解锁', () => {
  ...
  test('1811173-忘记密码-打开文件选择对话框选择任意错误保险箱密钥文件解锁', async ({ device, agent, uos, env, system }) => {    
  ...
  }, { timeout: 1300000, tags: ['1811173','level3','main_interface_area','fixed_directory','vault','DITT','lanyanling'] });
