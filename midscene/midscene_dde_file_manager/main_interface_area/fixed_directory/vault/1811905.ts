/**
 * 用例 PMSID: 1811905
 * 用例标题: 设置解锁方式弹窗-密码输入框-输入大于24位字符
 * 生成时间: 2026-1-23 9:00:00
 * 用例编写人: UT005160(蓝雁玲)
 */
...
describe('1811905-设置解锁方式弹窗-密码输入框-输入大于24位字符', () => {
  ...
  test('1811905-设置解锁方式弹窗-密码输入框-输入大于24位字符', async ({ device, agent, uos, env, system }) => {
    ...
    await agent.aiInput("Uos123!!1234567890abc1234","含有至少8位文字的输入框");
    await agent.aiAssert("光标所在输入框内容为:Uos123!!1234567890abc123");
    await system.exec("ps aux |grep dde-file-manager | grep -v grep | awk '{print $2}' | xargs kill -15");

  }, { timeout: 1200000, tags: ['1811905','level3','main_interface_area','fixed_directory','vault','DITT','lanyanling'] });
