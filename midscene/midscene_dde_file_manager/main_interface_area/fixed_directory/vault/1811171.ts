...
describe('1811171-指定路径密码找回-已选择密钥后重新选择密钥', () => {
  ...
  test('1811171-指定路径密码找回-已选择密钥后重新选择密钥', async ({ device, agent, uos, env, system }) => {    
  ...
  }, { timeout: 1200000, tags: ['1811171', 'level3', 'main interface area', 'fixed directory', 'vault', 'DITT', 'youwei', 'file-manager', 'encryption_file'] });
});