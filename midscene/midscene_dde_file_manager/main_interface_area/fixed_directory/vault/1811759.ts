 ...
 * 用例 PMSID: 1811759
 * 用例标题: 访问-已解锁保险箱入口检查
 * 生成时间: 2026-2-2 10:00:00
 * 用例编写人: UT005160(蓝雁玲)
 */

const caseDir = process.env.TESTCASE_DIR;

describe('1811759-访问-已解锁保险箱入口检查', () => {
  ...
  test('1811759-访问-已解锁保险箱入口检查', async ({ device, agent, uos, env, system }) => {    
    ...
    await agent.aiAssert("弹出一个新文件管理器窗口，且成功打开保险箱");
  ...
  }, { timeout: 1200000, tags: ['1811759','level3','main_interface_area','fixed_directory','vault','DITT','lanyanling'] });
