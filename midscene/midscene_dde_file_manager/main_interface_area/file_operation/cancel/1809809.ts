...
/**
 * 用例 PMSID: 1809809
 * 用例标题: samba远程路径新建文件后Ctrl+Z撤销新建操作，再利用Ctrl+Y恢复撤销
 * 生成时间: 2025-12-23 09:50:26
 * 用例编写人：UT002161(陈俞)
 */

describe('1809809-samba远程路径新建文件后Ctrl+Z撤销新建操作，再利用Ctrl+Y恢复撤销', () => {
    ...
    test('1809809-samba远程路径新建文件后Ctrl+Z撤销新建操作，再利用Ctrl+Y恢复撤销', async ({ device, agent, uos, system, env }) => {
    ...
    }, { timeout: 1200000, tags: ["1809809", "level3", "cancel", "chenyu"] });
