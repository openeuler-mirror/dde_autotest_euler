...
describe('1582911-[012]停止', () => {
    ...
    test('1582911-[012]停止', async ({ device, agent, uos}) => {
      // 步骤 1：打开系统服务
      ...
      // 验证：停止选中的服务，活动列更新为“未启动”
      await agent.aiAssert("alsa-restore的启动状态为'未启动'");
    }, { timeout: 600000, tags: ['1582911','level1','smoke'] });  
