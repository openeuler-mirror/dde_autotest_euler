...
describe('1583165-CPU详细信息页默认展示总体利用率', () => {
    ...
    test('1583165-CPU详细信息页默认展示总体利用率', async ({ device, agent, uos}) => {
      //步骤  1：点击“详细信息”切换到详细信息页
      await agent.aiTap("详细信息");
      //验证：默认展示CPU总体利用率，上方为总体利用率的图表，下方为CPU总体的性能参数
      await agent.aiAssert("窗口右侧默认展示CPU总体利用率,上方为总体利用率的图表,下方为CPU总体的性能参数");
    }, { timeout: 600000, tags: ['1583165','level2','smoke'] });  
