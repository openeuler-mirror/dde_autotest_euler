...
class TestDdeCase(BaseCase):
    ...
    def test_dde_1979911(self):
        """启动器打开日历管理-通用设置-增删日程类型"""
        euler = DdeMethod()
        ...
        self.assert_image_exist_in_dde("test_dde_1979911_4.png")

        # 删除
        euler.dde_dock.click_by_img("test_dde_1979911_4.png")
        euler.dde_dock.click_by_img("test_dde_1979911_2.png")
        self.assert_ocr_not_exist("yule")
