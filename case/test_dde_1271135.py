...
class TestDdeCase(BaseCase):
    def test_dde_1271135(self):
        ...
        sleep(10)
        DdeMethod().browser.dde_browser_method_right_click_by_ocr("开源社区")
        sleep(3)
        self.assert_image_exist_in_dde("test_dde_1271135_1.png")
        DdeMethod().browser.dde_browser_method_click_by_attr("新建标签页")
        DdeMethod().browser.dde_browser_method_click_by_attr("使用 百度 搜索，或者输入网址")
