...
class TestDdeCase(BaseCase):
    def test_dde_1956755(self):
        ...
        #【断言】:3.进入位置为下
        sleep(1)
        self.assert_image_exist_in_dde("dde_dock_down.png")
        # 点击切换成上
        euler=DdeMethod()
        euler.dde_dock.click_by_img("dde_dock_down.png")
        sleep(3)
        euler.dde_dock.click_by_img("dcc_dock_up.png")
        sleep(3)
        #【断言】:4.进入位置为上
        self.assert_dock_location(0)
        # 点击切换成下
        sleep(1)
        euler.dde_dock.click_by_img("dde_dock_up.png")
        sleep(3)
        euler.dde_dock.click_by_img("dcc_dock_down.png")
        sleep(3)
        #【断言】:5.进入位置为下
        self.assert_dock_location(2)
    
    @pytest.fixture(scope="function", autouse=True)
    def setup_teardown_1956755(self):
        """前置和后置"""
        yield
        #【后置】:1.关闭控制中心
        dock = DdeDockPublicWidget()
